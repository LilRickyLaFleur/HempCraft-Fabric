...
public class Strains {
    public Strains() {
        ...
        // GRADE AAA
        new HC_Strain("sour_budda").AAA(StatusEffects.INSTANT_HEALTH, StatusEffects.REGENERATION,
                StatusEffects.FIRE_RESISTANCE);
        new HC_Strain("blue_widow").AAA(StatusEffects.INSTANT_HEALTH, StatusEffects.STRENGTH,
